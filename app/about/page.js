        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              ...
              businesses and students with innovative solutions and educational
              support.
            </p>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-300 mb-4">
                At Alamny, we believe in the power of technology to transform
                businesses and education. Our mission is to provide cutting-edge
                solutions that drive growth and innovation while supporting the
                next generation of developers and technologists.
              </p>
              <p className="text-gray-300">
                We combine industry expertise with educational excellence to
                create a platform where businesses can thrive and students can
                learn and grow.
              </p>
            </div>
